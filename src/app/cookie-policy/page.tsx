...
export const metadata = pageMetadata({
  title: "Cookie Policy",
  description: "Cookie Policy for Profit Stacking Secrets, including analytics, affiliate links, and browser choices.",
  path: "/cookie-policy",
});

const sections = [
  { title: "How cookies may be used", body: "Profit Stacking Secrets may use cookies, pixels, log files, analytics tools, affiliate tracking, and similar technologies to operate the site, understand performance, remember basic preferences, and attribute qualifying purchases." },
  { title: "Affiliate links", body: "When you click an affiliate link, Amazon or another third-party retailer may use cookies or similar technologies under its own policies. Profit Stacking Secrets does not control those third-party tracking systems." },
  ...
  return (
    <main className="min-h-screen bg-[#f3f4f6] px-5 py-16 text-[#20292b]">
      <article className="mx-auto max-w-4xl rounded-lg bg-white p-8 shadow-sm sm:p-12">
        <Link href="/" className="text-sm font-bold uppercase tracking-[0.12em] text-[#a3421f]">Back to Profit Stacking Secrets</Link>

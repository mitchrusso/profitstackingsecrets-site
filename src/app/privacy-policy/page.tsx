...
export const metadata = pageMetadata({
  ...
  description:
    "Privacy Policy for Profit Stacking Secrets, including information about contact forms, analytics, cookies, and affiliate links.",
  path: "/privacy-policy",
});
    ...
    <main className="min-h-screen bg-[#f3f4f6] px-5 py-16 text-[#18211f]">
      <article className="mx-auto max-w-4xl rounded-lg bg-white p-8 shadow-sm sm:p-12">
        ...
        <p className="mt-6 text-base leading-8 text-[#5d6d66]">
          This Privacy Policy explains how Profit Stacking Secrets collects, uses, and protects information when you visit this website, read our content, contact us, or click affiliate links.
        </p>

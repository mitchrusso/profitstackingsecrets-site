...
export const metadata = pageMetadata({
  ...
  description: "Accessibility statement for Profit Stacking Secrets buying guides, reviews, resources, and affiliate shopping pages.",
    ...
    <main className="min-h-screen bg-[#f3f4f6] px-5 py-16 text-[#20292b]">
      <article className="mx-auto max-w-4xl rounded-lg bg-white p-8 shadow-sm sm:p-12">
        ...
        <p className="mt-6 text-base leading-8 text-[#536166]">
          Profit Stacking Secrets aims to make its buying guides, reviews, resource articles, and legal pages usable for as many readers as possible.
        </p>

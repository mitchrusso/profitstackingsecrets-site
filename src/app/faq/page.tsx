...
export const metadata: Metadata = pageMetadata({
  title: "Partner Offer FAQ",
  description:
    "Answers to common questions about Profit Stacking Secrets, curated partner offers, affiliate links, submissions, and buyer due diligence.",
  path: "/faq",
});
    ...
    <main className="min-h-screen bg-[#f3f4f6] px-5 py-16 text-[#18211f]">
      ...
      <article className="mx-auto max-w-4xl rounded-lg bg-white p-8 shadow-sm sm:p-12">
        <Link href="/" className="text-sm font-bold uppercase tracking-[0.12em] text-[#0e7a5f]">
          Back to Profit Stacking Secrets
        </Link>
        <h1 className="mt-8 text-4xl font-black">Partner Offer FAQ</h1>
        <p className="mt-6 text-base leading-8 text-[#5d6d66]">
          Quick answers about using Profit Stacking Secrets, comparing partner offers, understanding affiliate links, and submitting curated business opportunities.
        </p>

# Profit Stacking Secrets.com SEO Launch Checklist

## Google Search Console

1. Add the URL-prefix property for `https://profitstackingsecrets.com`.
2. Submit the sitemap:

   ```text
   https://profitstackingsecrets.com/sitemap.xml
   ```

3. Inspect and request indexing for:
   - `https://profitstackingsecrets.com/`
   - `https://profitstackingsecrets.com/resources`
   - `https://profitstackingsecrets.com/resources/safer-baby-products-to-buy-first`
   - `https://profitstackingsecrets.com/resources/topics/baby-proofing-checklist`
   - `https://profitstackingsecrets.com/resources/topics/car-seat-safety`
   - `https://profitstackingsecrets.com/compare/hardware-mounted-vs-pressure-mounted-baby-gates`
...
1. Confirm `https://profitstackingsecrets.com/llms.txt` loads.
